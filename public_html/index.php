...
<head>
	...
	<link rel="stylesheet" href="https://maxcd.bootstraocdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
		...
		<header>
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-1"><h1>Isles </h1></div>
					</div>
				</div> <!-- 1st row -->
				<div class="row">
					<div class="designs">
						<!-- second part of title should be offside google font-->
						<div class="col-2"><h1>Designs</h1></div>
					</div>
					</div> <!-- 2nd row -->
			</div> <!--container -->
		</header>
